...
export default function WeatherSensorsPage() {
  ...
  const weatherSource = weatherData?.source || 'IMD Telemetry Network';
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-[#0D0E10] border border-[#D9E2DE] dark:border-[#27272A] shadow-xs space-y-2">
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-2xl font-black text-sky-600 dark:text-sky-400">{rain24h}</span>
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-[#0D0E10] border border-[#D9E2DE] dark:border-[#27272A] shadow-xs space-y-2">
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-2xl font-black text-blue-600 dark:text-blue-400">{rain72h}</span>
            <span className="text-xs font-bold text-slate-400">mm</span>
          </div>
          <div className="w-full h-1.5 bg-slate-100 dark:bg-zinc-800 rounded-full overflow-hidden">
            <div
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-[#0D0E10] border border-[#D9E2DE] dark:border-[#27272A] shadow-xs space-y-2">
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-2xl font-black text-indigo-600 dark:text-indigo-400">{rain7d}</span>
            <span className="text-xs font-bold text-slate-400">mm</span>
          </div>
          <div className="w-full h-1.5 bg-slate-100 dark:bg-zinc-800 rounded-full overflow-hidden">
            <div
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-[#0D0E10] border border-[#D9E2DE] dark:border-[#27272A] shadow-xs space-y-2">
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-2xl font-black text-amber-600 dark:text-amber-400">{peakIntensity}</span>
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-[#0D0E10] border border-[#D9E2DE] dark:border-[#27272A] shadow-xs space-y-2">
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-2xl font-black text-[#006B4F] dark:text-emerald-400">{forecast24h}</span>
            <span className="text-xs font-bold text-slate-400">mm</span>
          </div>
